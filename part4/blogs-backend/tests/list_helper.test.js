...
describe('total likes', () => {
  ...
  const listWithMoreThanOneBlog = [
    ...
    },
    {
      ...
      title: 'Go To Statement Considered Harmful Duplicate',
      author: 'Edsger W. Dijkstra',
      url: 'https://homepages.cwi.nl/~storm/teaching/reader/Dijkstra68.pdf',
      likes: 7,
      __v: 0,
...
describe('favourite blog', () => {
  ...
  test('of list with only one blog, equals the blog of first element', () => {
  ...
  test('of list with more than one blog, shows correct result', () => {
